let styles = {
    main: "min-h-screen text-yellow-200 pt-96 text-sm md:text-lg bg-red-800",
    ...
    contact:"flex flex-col rounded-3xl pb-8 mt-20 mb-20",
    ...
    image: "rounded-3xl",
    logo: "flex flex-col lg:grid lg:grid-rows-1 lg:grid-flow-col md:justify-around gap-y-16 pb-40 pt-32 rounded-3xl m-6",
};
